...
def main():
    ...
    navigate_wait(x=0, y=7, z=1, frame_id='aruco_map', speed=0.5)
    navigate_wait(x=7, y=7, z=1, frame_id='aruco_map', speed=0.5)
    navigate_wait(x=7, y=0, z=1, frame_id='aruco_map', speed=0.5)
    navigate_wait(x=3.5, y=3.5, z=1, frame_id='aruco_map', speed=0.5)
    land()
